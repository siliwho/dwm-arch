...
static const char *fonts[] = {
    "JetBrains Mono Nerd Font:semibold:size=7.5:antialias=true"};
...
/*static const char *screenshotcmd[] = {"scrot", "-e", "xclip -selection
 * clipboard -t image/png -i $f", NULL};*/
// static const char *screenshotcmd[] = {"flameshot", "gui", NULL};
static const char *screenshotcmd[] = {"sh", "-c",
                                      "pkill flameshot; flameshot gui -r | "
                                      "xclip -selection clipboard -t image/png",
                                      NULL};
static const char *powermenu[] = {
    "/home/siliwho/.config/rofi/powermenu/type-5/powermenu.sh", NULL};
...
static const Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){0, XF86XK_AudioMute, spawn, {.v = mutecmd}},
